...
กราฟแท่งแสดงจำนวนภาพยนตร์ของแต่ละประเทศ ประเทศที่ผลิตภาพยนตร์ที่มากที่สุดคือ ประเทศอินเดีย
...
4. ภาพยนตร์หรือซีรีส์มีความนิยมมากกว่ากัน
	...
	Ans.
ภาพยนตร์มีความนิยมมากกว่าซีรีส์ เพราะคะแนนรวมโหวตทั้งหมดของภาพยนตร์มากกว่าซีรีส์

5. ความนิยมของนักแสดงหรือผู้กำกับมีผลกับความนิยมภาพยนตร์และซีรีส์หรือไม่

	Ans.
นักแสดงที่ได้รับบทบ่อย ๆ ส่วนใหญ่จะไม่ได้เป็นตัวละครหลัก ที่ไม่ใช่ตัวตัดสินใจว่าเราจะดูเรื่องนั้นหรือไม่ เพราะส่วนมากการตัดสินใจของเราจะอยู่ที่บทนำอย่างพระเอกนางเอก และเมื่อเรานำรายชื่อค้นหาใน google พบว่านักแสดงส่วนใหญ่ที่มีผลงานออกมาบ่อย ๆ พวกเขาไม่ได้เป็นตัวละครหลัก ดังนั้นข้อมูลชุดนี้ไม่สามารถตัดสินใจได้ว่าความนิยมของนักแสดงหรือผู้กำกับมีผลกับความนิยมภาพยนตร์และซีรีส์หรือไม่และจากที่เราพบว่า Ahn Nae-sang (อันแนซัง) และ Aamir Khan (อาเมียร์ ข่าน) มีบทบาทเกี่ยวกับซีรีส์และภาพยนตร์ที่ได้รับความนิยมมากที่สุดตามลำดับ 

6. ภาพยนตร์และซีรีส์ปล่อยออกในปีไหนที่ Netflix เลือกมาเข้ามาฉายเยอะที่สุด

	Ans.
- ซีรีส์ในปี 2018 Netflix เลือกมาเข้ามาฉาย 51 เรื่อง ซึ่งเป็นปีที่เลือกเข้ามาฉายเยอะที่สุด
- ภาพยนตร์ในปี 2019 Netflix เลือกมาเข้ามาฉาย 18 เรื่อง ซึ่งเป็นปีที่เลือกเข้ามาฉายเยอะที่สุด

## Challenge
1. column genres เป็น type string ที่อยู่ในรูปแบบของ list ทำให้ใช้ groupby ตามปกติไม่ได้ต้องเปลี่ยนจาก string เป็น list ก่อนจากนั้นนับจำนวน genres แต่ละอันใน list
2. คะแนน imdb_score and imdb_vote อาจจะยังไม่น่าเชื่อถือพอจึงควรจะนำคะแนนอื่นๆ เพิ่มเติม มาเปรียบเทียบด้วยว่าเรื่องที่นิยมมากที่สุดหรือคะแนนมากที่สุดคือเรื่องเดียวกันหรือไม่
3. ยังไม่แน่ใจว่าข้อมูลชุดนี้เหมาะกับกราฟประเภทไหนบ้าง หรือว่าสามารถทำเป็นกราฟประเภทไหนได้อีกบ้าง
