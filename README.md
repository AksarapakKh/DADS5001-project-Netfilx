...
ตรวจสอบคอลัมน์ที่เรานำมาวิเคราะห์ว่ามี Nan มั้ยในตาราง 	
	...
	df_titles
	df_titles.isna().sum()
เช็คว่าในคอลัมน์ imdb_score มี Nan มั้ย

	df_titles.loc[df_titles['imdb_score'].isna()]

เช็คว่าในคอลัมน์ imdb_votes มี Nan มั้ย
	
	df_titles.loc[df_titles['imdb_votes'].isna()]

เช็คว่าในคอลัมน์ imdb_id มี Nan มั้ย

	df_titles.loc[df_titles['imdb_id'].isna()]
